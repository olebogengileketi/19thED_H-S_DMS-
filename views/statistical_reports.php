...
$selectExtra = ", COALESCE(m.joined_ypd_yes, 0) AS joined_ypd_yes, COALESCE(m.full_church_yes, 0) AS full_church_yes";
...
$totals = ['total_members'=>0,'MB'=>0,'AS_'=>0,'Y'=>0,'YA'=>0,'male'=>0,'female'=>0,
           'vote_conf_yes'=>0,'vote_epi_yes'=>0,'joined_ypd_yes'=>0,'full_church_yes'=>0,'events_count'=>0,'total_attendance'=>0];
      ...
      <table class="table table-bordered table-sm mb-0">
        ...
        <tbody>
          ...
          <?php else: foreach ($stats as $row): ?>
            <tr>
              ...
              <td><?= (int)($row['joined_ypd_yes'] ?? 0) ?></td>
              <td><?= (int)($row['full_church_yes'] ?? 0) ?></td>
        ...
        <tfoot class="table-light fw-bold">
          <tr>
            ...
            <td><?= $totals['joined_ypd_yes'] ?></td>
            <td><?= $totals['full_church_yes'] ?></td>
